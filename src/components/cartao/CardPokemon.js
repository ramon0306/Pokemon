      ...
      <div>
        ...
        <div className="pokemon-info">
          ...
          <ul>
            ...
            <li><h3 className="weight"><strong>Peso: </strong> {this.props.weight / 10}kg</h3></li>
            <li><h3 className="height"><strong>Altura: </strong> {this.props.height / 10}m</h3></li>
            ...
            <li><h3 className="stats"><strong>Caracteristicas: </strong>{this.props.estatistica}</h3></li>
          </ul>
        </div>
